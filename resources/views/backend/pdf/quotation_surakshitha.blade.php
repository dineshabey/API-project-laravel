...
<head>
    ...
    <title>Platinum Quotation</title>
    <style type="text/css">
                    ...
                    <table class="width-100pc">
                        ...
                        <tr>
                            <td width="30%" class="text-center">
                                <img src="{{public_path('img/backend/brand/surakshitha_logo.png')}}" >
                            </td>
    ...
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class="bordered width-100pc">
                ...
                <tr>
                    <td width="40%" >Allocation Rate</td>
...
<div class="wrapper" style="margin-top: 18px;">
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class="width-100pc">
                <tr>
                    <td>*SAR refers to Basic Cover less amount of Investment Account at the payment point.</td>
                </tr>
                <tr>
                    <td>Tabarru Charge and Administration Fee shall be deducted from Investment Account at the payment point.</td>
                </tr>
                <tr>
                    <td>Fund Management Charge shall be charged on a daily basis by adjusting unit price. It may be revised depending on the experience of the Company, in the cost of administration of funds and such it may increase or decrease.</td>
                </tr>
    ...
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class="bordered width-100pc">
                ...
                <tr>
                    <td >Payable on Death</td>
                    <td >Basic Cover or  the fund value in the Investment Account whichever is higher plus AFP cover if obtained</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class="width-100pc">
                ...
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td>In the event of death and liability is accepted Amana Takaful Life PLC  will pay the life cover. However if the fund  value is higher than the basic cover Amana Takaful Life PLC will pay the higher fund value. Your  final  return  will  be based on  the  actual fund performance and  other factors  such as early  encashment charge  and  the cost of Takaful Benefits. You should  only  invest on this plan if you plan to pay your contribution for the complete term, as you may suffer a loss should you terminate  this  plan early. The rate of return in this document are for illustrative purposes only. The final fund value may be higher or  lower depend on the market performance. This illustration is valid for thirty (30) days from the date of generation given above.
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class=" width-100pc">
                ...
                <tr>
                    <td width="2%">6</td>
                    <td width="98%">You have the right to cancel the certificate within twenty one (21) days of receipt of the certificate, where upon the company will refund the contribution paid less medical expenses and underwriting expenses incurred in assesing the risk under your certificate.</td>
                </tr>
                <tr>
                    <td width="2%">7</td>
    ...
    <div class="divTable">
         <div class="divTableCell" style="width: 100%">
            <table class="width-100pc">
                ...
                <tr>
                    <td>
                        *The Requirements are subject to revision based on the total sum covered (Including previous  policies) and as per Amana
                    </td>
                </tr>
            </table>
        </div>
