...
class CreateInsuredBenefitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prop_insured_benefits', function (Blueprint $table) {
    ...
    {
        Schema::table('prop_insured_benefits', function (Blueprint $table) {
            $table->dropForeign(['proposal_id']);
        });
        Schema::dropIfExists('prop_insured_benefits');
    }
}
