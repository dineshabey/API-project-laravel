...
class CreateDynamicQuestionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('prop_dynamic_questions', function (Blueprint $table) {
    ...
    {
        Schema::table('prop_dynamic_questions', function (Blueprint $table) {
            $table->dropForeign(['proposal_id']);
        });
        Schema::dropIfExists('prop_dynamic_questions');
    }
}
