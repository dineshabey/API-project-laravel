...
class PremiumCalcHelper
{
    ...
    /** Get occupation name by occupation code */
    public static function get_occupation_name_by_code($occ_code)
    {
        $occ_data = DB::table('tbl_occupation_extras')->where('occ_code', $occ_code)
            ->select('occ_name')
            ->get()->toArray();
        return isset($occ_data[0]) ? $occ_data[0] : false;
    }
